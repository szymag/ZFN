...
class MacierzDoZagadnienia:
    ...
    def __init__(self, input_fft, ilosc_wektorow, wektor_q, a=ParametryMaterialowe.a, b=ParametryMaterialowe.b,
        ...
        self.a = a
        self.b = b
        self.rec_vector_x = ilosc_wektorow
        self.rec_vector_y = ilosc_wektorow
        self.d = d
        self.x = x
        self.H0 = H0
        ...
        tmp = int(sqrt(self.rec_vector_x))
    ...
    def pole_wymiany_II(self, wektor_2):
        ...
        tab_from_wektor_1 = np.asfortranarray(
            np.broadcast_to(self.lista_wektorow, (self.rec_vector_x, self.rec_vector_x, 2)), dtype=int)
    ...
    def wypelnienie_macierzy(self):
        ...
        self.macierz_M[self.rec_vector_x:, 0:self.rec_vector_x] += -tmp1 - tmp3 + tmp4
        self.macierz_M[0:self.rec_vector_x, self.rec_vector_x:] += tmp1 + tmp2 - tmp4
        pool.close()
