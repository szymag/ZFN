...
def frequency_k_0_versus_magnetic_field():
    ...
    for i in range(1, 50):
        x_axis.append(i)
        y_axis_1.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[1])
        y_axis_2.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[2])
        y_axis_3.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[3])
        y_axis_4.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[4])
        y_axis_5.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[5])
        y_axis_6.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[6])
        y_axis_7.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[7])
        y_axis_8.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[8])
        y_axis_9.append((np.loadtxt('dys_' + str(i) + '.txt') / 10e8)[9])
